...
<body>
    <div class="form-container">
        <form method="post" action="" id="formCurso" name="formCurso">
            <h1>Criar Novo Curso</h1>
            
            <div class="form-group">
                <label for="criarNome">Nome do Curso</label>
                <input type="text" id="criarNome" name="criarNome" required>
            </div>
            
            <div class="form-group">
                <label for="criarImagem">Imagem (URL)</label>
                <input type="text" id="criarImagem" name="criarImagem" required>
            </div>
            
            <div class="form-group">
                <label for="criarDescricao">Descrição</label>
                <textarea id="criarDescricao" name="criarDescricao" required></textarea>
            </div>
