    ...
    <div class="form-container">
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" id="imagem" name="imagem" value="<?= htmlspecialchars($curso['imagem']) ?>" required>
            </div>
            
            <div class="form-group">
                <label for="descricao">Descrição</label>
                <textarea id="descricao" name="descricao" required><?= htmlspecialchars($curso['descricao']) ?></textarea>
            </div>
