          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="actions-cell">
                <a href="./../gerenciar-editar-utilizador/<?= $utilizador[0] ?>" class="action-btn edit" title="Editar">
                ...
                <a href="./../gerenciar-remover-utilizador/<?= $utilizador[0] ?>" class="action-btn remove" title="Remover" onclick="return confirm('Tem a certeza que deseja remover este utilizador?')">
